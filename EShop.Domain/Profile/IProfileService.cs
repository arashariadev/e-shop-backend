...
namespace EShop.Domain.Profile
{
    public interface IProfileService
    {
        ...
        Task<DomainResult> UpdateProfileAsync(string id, string firstName, string lastName, string phoneNumber);
    }
    ...
    public class ProfileService : IProfileService
    {
        ...
        public async Task<DomainResult> UpdateProfileAsync(string id, string firstName, string lastName, string phoneNumber)
        {
